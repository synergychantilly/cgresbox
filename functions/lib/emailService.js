...
class EmailService {
    ...
    async initialize() {
        ...
        try {
            ...
            const gmailPassword = ((_a = functions.config().gmail) === null || _a === void 0 ? void 0 : _a.app_password) || process.env.GMAIL_APP_PASSWORD;
            if (gmailPassword) {
    ...
    generateRegistrationEmail(data) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    async sendRegistrationEmail(email, data) {
